...
public class HDAccount extends Address {
    ...
    private void initHDAccount(DeterministicKey accountKey, EncryptedData encryptedMnemonicSeed,EncryptedData encryptedHDSeed, boolean isFromXRandom, boolean
    ...
    public static class HDAccountAddress {
        ...
        public HDAccountAddress(byte[] pub, AbstractHD.PathType pathType, int index, boolean isSyncedComplete, int hdAccountId) {
            this(Utils.toAddress(Utils.sha256hash160(pub)), pub, pathType, index, false,isSyncedComplete, hdAccountId);
        }
