...
public class HotActivity extends BaseFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        LogUtil.i("ansen","HotActivity onCreate");
        ...
        flAddAddress.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isPrivateKeyLimit && isWatchOnlyLimit) {
                    DropdownMessage.showDropdownMessage(HotActivity.this,R.string.private_key_count_limit);
                    DropdownMessage.showDropdownMessage(HotActivity.this,R.string.watch_only_address_count_limit);
                    return;
                }
