...
public class HDAccountHotUEntropyActivity extends UEntropyActivity {
    ...
    void didSuccess(Object obj) {
        LogUtil.i("ansen","HDAccountHotUEntropyActivity didSuccess");
        ...
        DialogFragmentHDMSingularColdSeed.newInstance(words, AddressManager.getInstance()
                ...
                DialogFragmentHDMSingularColdSeed.DialogFragmentHDMSingularColdSeedListener() {
                    ...
                    public void HDMSingularColdSeedRemembered() {
                        ...
                        LogUtil.i("ansen","HDAccountHotUEntropyActivity 返回主页");
                    }
    ...
    private class GenerateThread extends ThreadNeedService {
        ...
        public void runWithService(BlockchainService service) {
            ...
            try {
                ...
                LogUtil.i("ansen","HDAccountHotUEntropyActivity xRandom:"+xRandom+" entropyCollector:"+entropyCollector+" cancelRunnable:"+cancelRunnable+" 密码:"+password);
                ...
                HDAccount hdAccount = new HDAccount(xRandom, password, new HDAccount.HDAccountGenerationDelegate() {
                    @Override
                    public void onHDAccountGenerationProgress(double p){
                        onProgress(Math.min(1.0, p * (1.0 - startProgress - saveProgress) +startProgress));
                    }
                });
                if (cancelRunnable != null) {
                    finishGenerate(service);
                ...
                for (String str:words){
                    LogUtil.i("ansen","HDAccountHotUEntropyActivity 单词:"+str);
                }
            ...
            if (success) {
                ...
                LogUtil.i("ansen","HDAccountHotUEntropyActivity success:"+success);
            } else {
                onFailed();
            }
        }
