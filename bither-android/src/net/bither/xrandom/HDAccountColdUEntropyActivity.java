...
public class HDAccountColdUEntropyActivity extends UEntropyActivity {
    ...
    void didSuccess(Object obj) {
        LogUtil.i("ansen","HDAccountColdUEntropyActivity didSuccess");
    ...
    private class GenerateThread extends ThreadNeedService {
        ...
        public void runWithService(BlockchainService service) {
            ...
            LogUtil.i("ansen","HDAccountColdUEntropyActivity runWithService:"+service);
            ...
            try {
                ...
                LogUtil.i("ansen","HDAccountColdUEntropyActivity xRandom:"+xRandom+" entropyCollector:"+entropyCollector+" cancelRunnable:"+cancelRunnable+" 密码:"+password);
            ...
            LogUtil.i("ansen","HDAccountColdUEntropyActivity success:"+success);
            if (success) {
