...
public abstract class UEntropyActivity extends BaseFragmentActivity implements UEntropyCollector
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        UEntropyCamera uEntropyCamera=new UEntropyCamera((SurfaceView) findViewById(R.id.v_camera),entropyCollector);//相机
        UEntropyMic uEntropyMic=new UEntropyMic(entropyCollector,(AudioVisualizerView) findViewById(R.id.v_mic));//音频
        UEntropySensor uEntropySensor=new UEntropySensor(this,entropyCollector, (SensorVisualizerView) findViewById(R.id.v_sensor));//传感器
        entropyCollector.addSources(uEntropyCamera, uEntropyMic, uEntropySensor);

        vOverlay.postDelayed(new Runnable(){
            @Override
            public void run() {
                LogUtil.i("ansen","弹出密码输入框");
                DialogPassword dialogPassword = new DialogPassword(UEntropyActivity.this,UEntropyActivity.this);
    ...
    private void stopAnimation(final Runnable finishRun) {
        ...
        bottomAnim.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                LogUtil.i("ansen","UEntropyActivity onAnimationEnd");
        ...
        LogUtil.i("ansen","UEntropyActivity startAnimation");
    }
    ...
    protected void onSuccess(final Object obj) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                LogUtil.i("ansen","UEntropyActivity onSuccess");
                stopAnimation(new Runnable() {
                    @Override
                    public void run() {
                        LogUtil.i("ansen","UEntropyActivity didSuccess");
    ...
    public void onPasswordEntered(final SecureCharSequence password) {
        LogUtil.i("ansen","点击确定按钮 密码:"+password);
        if (password == null) {
            backToFromActivity();
        } else {
            startAnimation();
