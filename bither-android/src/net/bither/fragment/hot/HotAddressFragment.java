...
public class HotAddressFragment extends Fragment implements Refreshable, Selectable {
    ...
    public void refresh() {
        LogUtil.i("ansen","HotAddressFragment addressIsReady:"+AbstractApp.addressIsReady);
        if (AbstractApp.addressIsReady) {
            ...
            List<HDMAddress> hs = AddressManager.getInstance().hasHDMKeychain() ? AddressManager.getInstance().getHdmKeychain().getAddresses() : null;

            if(ps!=null){
                LogUtil.i("ansen","HotAddressFragment ps长度:"+ps.size());
            }

            if(ws!=null){
                LogUtil.i("ansen","HotAddressFragment ws长度:"+ws.size());
            }

            if(hs!=null){
                LogUtil.i("ansen","HotAddressFragment hs长度:"+hs.size());
            }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        LogUtil.i("ansen","HotAddressFragment onCreateView");
        ...
        mAdapter = new HotAddressFragmentListAdapter(getActivity(), watchOnlys, privates, hdms, lv,isSplitBCCAddress);
