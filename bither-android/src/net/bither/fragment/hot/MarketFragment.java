...
public class MarketFragment extends Fragment implements Refreshable,Selectable, Unselectable, OnItemClickListener {
    private View v;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        markets = new ArrayList<>(MarketUtil.getMarkets());
