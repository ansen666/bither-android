...
public class CheckUtil {
    ...
    public static Check initCheckForPrivateKey(
        ...
        Check check = new Check(title, new ICheckAction() {
            ...
            public boolean check() {
                ...
                if (!result) {
                    try {
                        ECKey eckeyFromBackup = BackupUtil.getEckeyFromBackup(address.getAddress(), password);
    ...
    public static Check initCheckForHDAccount(final HDAccount account, final SecureCharSequence password) {
