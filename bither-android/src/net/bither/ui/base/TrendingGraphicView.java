...
//        if(data!=null&&data.getRates()!=null&&data.getRates().length>0){
//            for(double rate:data.getRates()){
//                LogUtil.i("ansen","TrendingGraphicView rate:"+rate);
//            }
//        }
        if (data == null) {
        ...
        if (rateAnimation == null) {
            rateAnimation = new RateAnimation(TrendingGraphicData.getEmptyData().getRates(),data.getRates());
        } else {
