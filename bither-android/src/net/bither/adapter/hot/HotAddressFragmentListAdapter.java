...
public class HotAddressFragmentListAdapter extends BaseExpandableListAdapter implements
    ...
    private class GroupViewHolder {
        ...
        private void hdmAdd() {
            ...
            activity.startActivityForResult(new Intent(activity, AddHDMAddressActivity.class),BitherSetting.INTENT_REF.SCAN_REQUEST_CODE);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild,View convertView, ViewGroup parent) {
        if (!isSplitBCCAddress) {
            ...
            if (a.isHDAccount() && !a.hasPrivKey()) {
                ...
                LogUtil.i("ansen","hdAccountMonitoredDetailClick");
            } else if (a.isHDAccount()) {
                view.ivType.setOnLongClickListener(hdAccountLongClick);
                view.setOnClickListener(hdAccountDetailClick);

                LogUtil.i("ansen","hdAccountDetailClick");
            } else {
                view.ivType.setOnLongClickListener(new AddressLongClick(a));
                view.setOnClickListener(new AddressDetailClick(childPosition, a.hasPrivKey(), a.isHDM(),a instanceof EnterpriseHDMAddress,a));

                LogUtil.i("ansen","AddressDetailClick");
            }
        } else {
    ...
    private class hdAccountDetailClick implements OnClickListener {
        ...
        @Override
        public void onClick(View v) {
            LogUtil.i("ansen","HotAddressFragmentListAdapter hdAccountDetailClick onClick");
            if (!clicked) {
                clicked = true;
                    if (isSyncComplete(a)) {
    ...
    private class hdAccountMonitoredDetailClick implements OnClickListener {
        ...
        @Override
        public void onClick(View v) {
            LogUtil.i("ansen","hdAccountMonitoredDetailClick onClick");
            if (!clicked) {
                clicked = true;
                if (isSyncComplete(a)) {
                    Intent intent = new Intent(activity, SplitBCCHDAccountMonitoredSendActivity.class);
                    activity.startActivityForResult(intent,SplitBccSelectAddressActivity.SPLIT_BCC_HDACCOUNT_REQUEST_CODE);
                }
                v.postDelayed(new Runnable() {
                    @Override
                    public void run() {
    ...
    private class AddressDetailClick implements OnClickListener {
        ...
        @Override
        public void onClick(View v) {
            LogUtil.i("ansen","AddressDetailClick onClick");
